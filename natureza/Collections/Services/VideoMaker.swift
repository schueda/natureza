...
class ImageAnimator {
    ...
    let repository = UserDefaultsPhotoRepository.shared
    ...
    init(renderSettings: RenderSettings, collection: PhotoCollection) {
        settings = renderSettings
        videoWriter = VideoWriter(renderSettings: settings)
        self.collection = collection
        images = repository.getImages(from: collection)
    }
